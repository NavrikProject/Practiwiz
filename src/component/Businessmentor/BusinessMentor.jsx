            ...
            <div className="row">
                  ...
                  <div className="duilehri_left">
                    <ul className="tabs">
                      <li
                        ...
                        id="tab15a"
                      >
                        <div className="dfghgghfg">
                          <div className="row">
                            <div className="col-lg-2">
                              <div className="gkbhfg">
                                <img src="./images/qqq3.png" alt="" />
                              </div>
                            </div>
                            <div className="col-lg-10">
                              <div className="mgjbhfghfgh">
                                <h6>
                                  Tarun Gautam{" "}
                                  <span>
                              ...
                              <div className="kdfhjfg">
                                <p>
                                  Product Supply Manager - P&G | IIT Madras |
                                  Unstop B-School Leader'23 | National Winner -
                                  Infosys
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="dfhjbg2">
                      ...
                      <li className="tab-link" data-tab="tab-16" id="tab15b">
                        <div className="dfghgghfg">
                          <div className="row">
                            <div className="col-lg-2">
                              <div className="gkbhfg">
                      ...
                      <li className="tab-link" data-tab="tab-17" id="tab15c">
                        <div className="dfghgghfg">
                          <div className="row">
                            <div className="col-lg-2">
                              <div className="gkbhfg">
                      ...
                      <li className="tab-link" data-tab="tab-18" id="tab15d">
                        <div className="dfghgghfg">
                          <div className="row">
                            <div className="col-lg-2">
                              <div className="gkbhfg">
                                <img src="./images/qqqq6.jpg" alt="" />
                              </div>
                            </div>
                            <div className="col-lg-10">
                              <div className="mgjbhfghfgh">
                      ...
                      <li className="tab-link" data-tab="tab-19" id="tab15e">
                        <div className="dfghgghfg">
                          <div className="row">
                            <div className="col-lg-2">
                              <div className="gkbhfg">
                      ...
                      <li className="tab-link" data-tab="tab-20" id="tab15f">
                        <div className="dfghgghfg">
                          <div className="row">
                            <div className="col-lg-2">
                              <div className="gkbhfg">
              ...
              <div className="col-lg-8">
                <div className="bnbgjhg">
                  <div id="tab-15" className="tab-content current">
                    <div className="ihstrerer bg-white">
                            ...
                            <div className="dhjgdfghgj">
                              ...
                              <div className="kdfhjfg">
                                <p>
                                  Product Supply Manager - P&G | IIT Madras |
                                  Unstop B-School Leader'23 | National Winner -
                                  Infosys Ingenious'22 & 6 Bschool Competitions
                                  | Ex-Wipro
                                </p>
                              </div>

                              <div className="d-flex justify-content-between align-items-center">
                                <div className="mkghdfgf2 d-flex align-items-center">
                                  <p>
                                    <i className="fa-solid fa-lock"></i> 3 Years
                                  </p>
                                  ...
                                  <p>
                                    <i className="fa-solid fa-comment"></i> 26
                                    Bookings
                                  </p>

                                  <p>
                                    <i className="fa-solid fa-clock"></i> 12
                                    hours
                                  </p>
                                </div>
                          ...
                          <div className="col-lg-5">
                            <div className="jghfttght d-flex align-items-center">
                              ...
                              <button className="btn d-flex align-items-center btn-main">
                                <i className="fa-regular me-1 fa-heart"></i>{" "}
                                +Watchlist
                              </button>
                            </div>
                          </div>
                    ...
                    <div className="dikherr p-3">
                      ...
                      <div className="jdfghfghfghfg">
                              ...
                              <div className="fjbffd">
                                ...
                                <div className="hjvbf">
                                  <span>
                                    {" "}
                                    <p>
                                      <i className="fa-solid fa-video"></i> 1:1
                                      Call
                                    </p>
                                  </span>

                                  <p>
                                    <i className="fa-regular fa-clock"></i> 30
                                    min
                                  </p>
                                </div>
                            ...
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                ...
                                <div className="hjvbf">
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 40
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                        ...
                        <div className="njbfghddfgf">
                          <h4>About Mentor</h4>
                          <p>
                            As a product supply manager, I have a passion for
                            optimizing supply chain operations and delivering
                            exceptional results. In addition to my professional
                            endeavors, I enjoy staying active through swimming
                            and playing football. I provide mentorship in both
                            career and academic aspects related to ...
                          </p>
                        </div>
                  ...
                  <div id="tab-16" className="tab-content">
                    <div className="ihstrerer bg-white">
                      <div className="hgdfggtf p-3">
                        <div className="row">
                          <div className="col-lg-2">
                          ...
                          <div className="col-lg-10">
                            <div className="dhjgdfghgj">
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                <div className="mkghdfgf2 d-flex align-items-center">
                                  <p>
                                    <i className="fa-solid fa-lock"></i> 5 Years
                                  </p>
                                  ...
                                  <p>
                                    <i className="fa-solid fa-comment"></i> 74
                                    Bookings
                                  </p>

                                  <p>
                                    <i className="fa-solid fa-clock"></i> 18.5
                                    hours
                                  </p>
                                </div>
                      ...
                      <div className="jdfghfghfghfg">
                        <div className="khrudghfgfdghfh">
                          <div className="row">
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                <h5>Mock Interviews - C-Schools Specific</h5>
                                <div className="hjvbf">
                                  <span>
                                    {" "}
                                    <p>
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 35
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                        ...
                        <div className="khrudghfgfdghfh">
                          <div className="row align-items-end">
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                <h5>Mock Interviews - B-Schools Specific</h5>
                                <div className="hjvbf">
                                  <span>
                                    {" "}
                                    <p>
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 49
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                  ...
                  <div id="tab-17" className="tab-content">
                    <div className="ihstrerer bg-white">
                      <div className="hgdfggtf p-3">
                        <div className="row">
                          <div className="col-lg-2">
                            ...
                            <div className="dhjgdfghgj">
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                <div className="mkghdfgf2 d-flex align-items-center">
                                  ...
                                  <p>
                                    <i className="fa-solid fa-clock"></i> 15
                                    hours
                                  </p>
                                </div>
                            ...
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                ...
                                <div className="hjvbf">
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 70
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                  ...
                  <div id="tab-18" className="tab-content">
                    <div className="ihstrerer bg-white">
                      <div className="hgdfggtf p-3">
                        <div className="row">
                          <div className="col-lg-2">
                            ...
                            <div className="dhjgdfghgj">
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                <div className="mkghdfgf2 d-flex align-items-center">
                                  ...
                                  <p>
                                    <i className="fa-solid fa-clock"></i> 16
                                    hours
                                  </p>
                                </div>
                      ...
                      <div className="jdfghfghfghfg">
                        <div className="khrudghfgfdghfh">
                          <div className="row">
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                <h5>Mock Interviews - G-Schools Specific</h5>
                                <div className="hjvbf">
                                  <span>
                                    {" "}
                                    <p>
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 65
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                            ...
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                ...
                                <div className="hjvbf">
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 25
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                  ...
                  <div id="tab-19" className="tab-content">
                    <div className="ihstrerer bg-white">
                      <div className="hgdfggtf p-3">
                        <div className="row">
                          <div className="col-lg-2">
                            ...
                            <div className="dhjgdfghgj">
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                <div className="mkghdfgf2 d-flex align-items-center">
                                  ...
                                  <p>
                                    <i className="fa-solid fa-clock"></i> 13.5
                                    hours
                                  </p>
                                </div>
                      ...
                      <div className="jdfghfghfghfg">
                            ...
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                ...
                                <div className="hjvbf">
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 62
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                        ...
                        <div className="khrudghfgfdghfh">
                          <div className="row align-items-end">
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                <h5>Mock Interviews - E-Schools Specific</h5>
                                <div className="hjvbf">
                                  <span>
                                    {" "}
                                    <p>
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 38
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
                  ...
                  <div id="tab-20" className="tab-content">
                    <div className="ihstrerer bg-white">
                      <div className="hgdfggtf p-3">
                        <div className="row">
                          <div className="col-lg-2">
                            ...
                            <div className="dhjgdfghgj">
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                <div className="mkghdfgf2 d-flex align-items-center">
                                  ...
                                  <p>
                                    <i className="fa-solid fa-clock"></i> 17
                                    hours
                                  </p>
                                </div>
                      ...
                      <div className="jdfghfghfghfg">
                        <div className="khrudghfgfdghfh">
                          <div className="row">
                            <div className="col-lg-9">
                              <div className="fjbffd">
                                <h5>Mock Interviews - H-Schools Specific</h5>
                                <div className="hjvbf">
                                  <span>
                                    {" "}
                                    <p>
                                  ...
                                  <p>
                                    <i className="fa-regular fa-clock"></i> 47
                                    min
                                  </p>
                                </div>
                                <div className="fhdfgf">
